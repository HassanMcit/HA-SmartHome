        ...
        {loadingW ? (
          ...
          <div className="flex-1 flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex gap-3">
              ...
              <div className="bg-lime-500/8 border border-lime-500/15 rounded-2xl px-4 py-3 flex flex-col items-center gap-0.5 min-w-[72px]">
                <Moon className="w-4 h-4 text-green-400 mb-0.5" />
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">مساءً</span>
                <span className="text-xl font-black text-green-400">{weather.eveningTemp}°</span>
              </div>
            </div>
          </div>
        ) : (
