                ...
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      {bill.isRecurring && <span className="text-[9px] font-black uppercase tracking-wider bg-sky-500/15 text-sky-400 px-2 py-0.5 rounded-md border border-sky-500/20 shrink-0">{lang === 'ar' ? 'متكررة' : 'Recurring'}</span>}
