          ...
          <div className="w-full sm:w-[300px]">
            ...
            <Select value={selectedUserId} onValueChange={(val) => setSelectedUserId(val || '')}>
              ...
              >
                ...
                >
                  <SelectItem value="all" className="font-bold text-green-400 focus:bg-white/10 rounded-lg">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button 
              ...
              className="w-full h-14 bg-lime-600 hover:bg-lime-500 text-white rounded-2xl font-black text-lg shadow-lg shadow-lime-600/20 active:scale-[0.98] transition-all disabled:opacity-50"
            >
              {submitting
                  ...
                  <div className="w-full h-3 bg-black/20 rounded-full overflow-hidden border border-white/5">
                    <div 
                      className={cn(
                        ...
                        isOverLimit ? "bg-red-500" : isNearLimit ? "bg-orange-500" : "bg-lime-500"
                      )}
                      style={{ width: `${percent}%` }}
                    />
                  </div>
