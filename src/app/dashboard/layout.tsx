...
export default function DashboardLayout({
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#070a13] gap-6">
  ...
  return (
    <div className="flex min-h-screen bg-[#070a13]">
      ...
      <main className="flex-1 min-w-0 overflow-x-hidden flex flex-col">
        ...
        {/* Mobile Header */}
        <header className="md:hidden sticky top-0 z-40 bg-[#070a13]/85 backdrop-blur-xl border-b border-white/5 px-6 py-4 flex items-center justify-between">
