  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#0f0f23] gap-6">
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-sky-500 to-purple-600 flex items-center justify-center shadow-lg shadow-sky-500/20 pulse-glow">
      ...
      <main className="flex-1 min-w-0 overflow-x-hidden flex flex-col">
        ...
        <header className="md:hidden sticky top-0 z-40 bg-[#1a1a35]/80 backdrop-blur-xl border-b border-white/5 px-6 py-4 flex items-center justify-between">
          <Link href="/dashboard" className="flex items-center gap-3 active:scale-95 transition-transform group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-sky-500 to-purple-600 flex items-center justify-center shadow-lg shadow-sky-500/20 group-hover:scale-110 transition-transform">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/dashboard/settings" className="group">
              <Avatar className="w-10 h-10 border-2 border-white/5 group-hover:border-sky-500/30 transition-all">
