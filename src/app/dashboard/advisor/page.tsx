    ...
    <div className="flex flex-col gap-6 pb-12 animate-fade-in" dir="rtl">
      ...
      {!fetched && !loading && (
        <div className="glass-card relative overflow-hidden">
          {/* top bar */}
          <div className="absolute top-0 inset-x-0 h-0.5 bg-gradient-to-r from-violet-500 via-purple-500 to-lime-500" />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                ...
                bg:     'bg-lime-500/10', text: analysis.balance >= 0 ? 'text-white' : 'text-red-400',
              },
              {
