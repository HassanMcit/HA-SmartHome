...
export default function RegisterPage() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-[#0d1b2a]">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-[#0d1b2a] relative overflow-hidden selection:bg-indigo-500/30">
      {/* Background orbs */}
